    ...
    <div id="services" className="mt-20 pt-7 lg:mt-32">
      <div className="container grid grid-cols-1 gap-4 lg:grid-cols-3">
        ...
        <div className="relative">
          ...
          {/* content  */}
          <div className="mb-8 mr-20 mt-[95px] rounded-3xl bg-lightbg px-8 pb-12 pt-20 text-black">
        ...
        <div className="relative">
          ...
          <div className="mb-8 mr-20 mt-[95px] rounded-3xl bg-lightbg px-8 pb-12 pt-20 text-black">
            ...
            <p className="mb-6 text-sm text-[#4a4a4a]">You can start learning HTML CSS by modifying free templates from our website too.</p>
            <div className="flex w-fit items-center justify-center rounded-3xl bg-white px-6 text-sm font-medium leading-10 text-primary">
              <span>Read More</span>
            </div>
          </div>
